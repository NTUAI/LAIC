...
namespace adminlte
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            //dashborad2
            bundles.Add(new StyleBundle("~/Scripts/player/css").Include(
           "~/Scripts/player/plyr.css",
           "~/Scripts/player/video-js.min.css"
            ));

            bundles.Add(new ScriptBundle("~/Scripts/player/js").Include(
                "~/Scripts/player/plyr.js",
                "~/Scripts/player/video.min.js",
                "~/Scripts/player/subtitles.min.js",
                "~/Scripts/player/vtt.min.js"
            ));
        }
    }
}
